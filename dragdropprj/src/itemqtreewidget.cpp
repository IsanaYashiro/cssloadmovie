...
ItemQTreeWidget::ItemQTreeWidget(QWidget *parent)
	: QTreeWidget(parent)
{
	addItem();
...
ItemQTreeWidget::~ItemQTreeWidget()
{
}

void ItemQTreeWidget::mouseMoveEvent(QMouseEvent *event)
{
